class ControlDivObstaculos{
    ...
    secuenciaAnimacion(){
        ...
        this.time1=  setTimeout(()=> {this.viewDivObstaculo.aplicarAnimacion(this.divSuelo1, this.tiempoAnimacion)}, 0);
            ...
            setTimeout(()=> {this.viewDivObstaculo.detenerAnimacion(this.divSuelo1);}, this.tiempoAnimacion);//4000 tiempoAnimacion->4
        ////////////////SUELO///////////////////
        ...
        this.time2=    setTimeout(()=> {this.viewDivObstaculo.aplicarAnimacion(this.divSuelo2, this.tiempoAnimacion);}, this.tiempoAnimacion/2);//2000 tiempoAnimacion->4
            //remueve la animacion para poder aplicarse devuelta más tarde
            setTimeout(()=> {this.viewDivObstaculo.detenerAnimacion(this.divSuelo2);}, this.tiempoAnimacion + 1500);//5500 tiempoAnimacion->4
        ////////////////AIRE///////////////////
        ...
        this.time3=    setTimeout(()=> {this.viewDivObstaculo.aplicarAnimacion(this.divAire1, this.tiempoAnimacion)}, this.tiempoAnimacion);//4000 tiempoAnimacion->4
            ...
            setTimeout(()=> {this.viewDivObstaculo.detenerAnimacion(this.divAire1);}, this.tiempoAnimacion*2);//8000 tiempoAnimacion->4
        ////////////////SUELO///////////////////
        //cuarto obstaculo de suelo
            ...
            //remueve la animacion para poder aplicarse devuelta más tarde
            setTimeout(()=> {this.viewDivObstaculo.detenerAnimacion(this.divSuelo1);}, (this.tiempoAnimacion*3)-1000);//11000 tiempoAnimacion->4
        ////////////////AIRE///////////////////
        //quinto obstaculo de aire
            ...
            //remueve la animacion para poder aplicarse devuelta más tarde
        this.timeFinal=    setTimeout(()=> {this.viewDivObstaculo.detenerAnimacion(this.divAire1);
